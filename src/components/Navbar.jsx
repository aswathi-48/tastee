...
<div className={`navbar xl:px-24 ${isSticky ? "shadow-md bg-base-100 transition-all duration-300 ease-in-out" : ""}`}>
 ...
 <button className="btn btn-ghost btn-circle ">
  ...
  <label tabIndex={0} role="button" className="btn btn-ghost btn-circle mr-3 lg:flex hidden items-center justify-center">
   ...
   {/* login button */}
    <button onClick={()=>document.getElementById('my_modal_5').showModal()} className="btn bg-green rounded-full px-6 text-white gap-2"><FaRegUser />Login</button>
   <Modal/>
  </div>
</div>  
</header>  
